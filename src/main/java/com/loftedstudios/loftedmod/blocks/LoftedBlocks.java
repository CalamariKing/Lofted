...
public class LoftedBlocks {
    ...
    // Wood
    public static final Block FEYWOOD_LOG = registerBlock("feywood_log", new PillarBlock(FabricBlockSettings.copy(Blocks.OAK_LOG).strength(4.0f).requiresTool()), LoftedItemGroup.LOFTED_ITEMGROUP);

    public static final Block FEYWOOD_WOOD = registerBlock("feywood_wood", new PillarBlock(FabricBlockSettings.copy(Blocks.OAK_WOOD).strength(4.0f).requiresTool()), LoftedItemGroup.LOFTED_ITEMGROUP);

    public static final Block STRIPPED_FEYWOOD_LOG = registerBlock("stripped_feywood_log", new PillarBlock(FabricBlockSettings.copy(Blocks.STRIPPED_OAK_LOG).strength(4.0f).requiresTool()), LoftedItemGroup.LOFTED_ITEMGROUP);
    ...
    public static final Block FEYWOOD_SLAB = registerBlock("feywood_slab", new SlabBlock(AbstractBlock.Settings.of(Material.WOOD, MapColor.OAK_TAN).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)), LoftedItemGroup.LOFTED_ITEMGROUP);
