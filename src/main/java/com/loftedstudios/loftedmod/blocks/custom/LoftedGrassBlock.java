...
public class LoftedGrassBlock extends SpreadableBlock implements Fertilizable {

    public LoftedGrassBlock(Settings settings) {
        super(settings);
    }
    ...
    public void randomTick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
        if (!LoftedGrassBlock.stayAlive(state, world, pos)) {
            world.setBlockState(pos, LoftedBlocks.MINSTONE.getDefaultState());
        }
    }
